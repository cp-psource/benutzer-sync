            ...
            <div class="wrap">
                ...
                <p>
                    ...
                    <a href="https://cp-psource.github.io/benutzer-sync/" target="_blank" ><?php _e( 'Anweisungen zur Installation und Verwendung der WordPress-Benutzersynchronisierung.', 'user-sync' ) ?></a>
                </p>
                ...
                <form method="post" action="" id="user_sync_form">
                    ...
                    <input type="hidden" name="user_sync_status" id="user_sync_status" value="" />
                                ...
                                <p class="debug_message" >
                                    ...
                                    <a href="https://cp-psource.github.io/benutzer-sync/" target="_blank" ><?php _e( 'hier', 'user-sync' ) ?></a>
                                    <br /><br />
